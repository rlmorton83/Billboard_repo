...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post rails_url, params: { rail: { auth: @rail.auth, category: @rail.category, proj: @rail.proj } }
    end
  ...
  test "should update rail" do
    patch rail_url(@rail), params: { rail: { auth: @rail.auth, category: @rail.category, proj: @rail.proj } }
